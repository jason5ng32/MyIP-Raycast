...
- **IP in Menu Bar** — your current external IP and its country flag, always one glance away. Pick the source, the label style and how often it refreshes (5–60 minutes). macOS only, since Raycast has no menu bar on Windows.
